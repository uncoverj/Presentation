...
export function CryptographySlide() {
  return (
    <SlideWrapper backgroundImage="/crypto-lock.jpg" particleVariant="cyan">
      <div className="flex flex-col h-full px-10 py-12 pb-24">
        ...
        >
          ...
          >
            <span className="text-neon-purple italic">Tamper-proof</span>{' '}
            <span className="text-white">by math</span>
          </motion.h2>
        </motion.div>
